		...
		<div class="modal-content">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal">&times;</button>
					...
					<form id="editar_usuario"  class="form-horizontal">

			<div class="modal-body">
				<div cl-ass="col-lg-6">
						<fieldset>
							<legend>Formulario Edicion Usuario</legend>
							...
							<div class="form-group">
								...
								<div class="col-lg-10">
									<input required type="text" class="form-control" name="correo"  id="correo" placeholder="Correo del Usuario">
								</div>
